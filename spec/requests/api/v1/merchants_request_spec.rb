...
describe "Merchants API" do
  ...
  it "can get all items for a given merchant ID" do
    ...
    merchant_items.each do |merchant_items|
      ...
      expect(merchant_items).to have_key(:name)
      expect(merchant_items[:name]).to be_a(String)
  
      expect(merchant_items).to have_key(:description)
      expect(merchant_items[:description]).to be_a(String)
  
      expect(merchant_items).to have_key(:unit_price)
      expect(merchant_items[:unit_price]).to be_a(Integer)
  
      expect(merchant_items).to have_key(:merchant_id)
      expect(merchant_items[:merchant_id]).to be_a(Integer)
    end
  end
end